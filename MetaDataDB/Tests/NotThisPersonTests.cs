...
internal sealed class NotThisPersonTests : DBSetup
{
    ...
    {
        Image data1 = Image.AddPersonTag(TestData.Image1, new(MetaData.Tests.TestData.PersonZero, TestData.Face3));
        data1 = DB.AddMetaData(data1, DateTimeOffset.Now);
        Image data2 = Image.AddPersonTag(TestData.Image2, new(MetaData.Tests.TestData.PersonZero, TestData.Face3));
    ...
    public void RemoveNotThisPersonInformation()
    {
        ...
        PersonTag pt = data1.PersonTags[1];
