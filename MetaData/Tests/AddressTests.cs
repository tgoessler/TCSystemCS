...
public class AddressTests
{
    ...
    {
        Address address1 = TestData.Address1;
    ...
    public void EqualsTest()
    {
        ...
        Address address2 = TestData.Address2;
        Assert.That(address1, !Is.EqualTo(address2));

        address2 = new(address1.Country, address1.Province, address1.City, address1.Street);
        Assert.That(address1, Is.EqualTo(address2));

        address2 = new("", address1.Province, address1.City, address1.Street);
        Assert.That(address1, !Is.EqualTo(address2));

        address2 = new(address1.Country, "", address1.City, address1.Street);
        Assert.That(address1, !Is.EqualTo(address2));

        address2 = new(address1.Country, address1.Province, "", address1.Street);
        Assert.That(address1, !Is.EqualTo(address2));

        address2 = new(address1.Country, address1.Province, address1.City);
        Assert.That(address1, !Is.EqualTo(address2));
    }
    ...
    {
        Address data1 = TestData.Address1;
